...
- Criar manutenção de partições de `event_chain` (job de criação automática mensal, ou processo manual) — parado desde 04/2026. Continua uma causa de fundo real (a partição "default" só cresce).
