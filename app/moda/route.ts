...
<title>DOOHPLAY para Lojas de Moda — Transforme a TV da loja em renda extra</title>
<meta name="description" content="Seu cliente já passa tempo navegando pelas araras e esperando no provador. Coloque uma TV, mostre sua coleção — e ainda ganhe dinheiro com anúncios enquanto ele decide.">
<style>
...
<!-- HERO -->
<div class="hero">
  <div class="hero-tag">👗 Feito para lojas de moda</div>
  <h1>Enquanto ela decide<br>o que experimentar,<br><span>você já está ganhando</span></h1>
  <p>Seu cliente já passa tempo navegando pelas araras e esperando no provador. Coloque uma TV, mostre sua coleção e promoções — e ainda ganhe dinheiro com anúncios enquanto ele decide.</p>
  <div class="hero-btns">
    ...
    <div class="tv-frame">
      <div class="tv-screen">
        ...
        <div class="tv-content">
          <div class="promo">👗 Coleção Nova</div>
          <div class="sub">Peças a partir de R$ 49,90</div>
        </div>
        <div class="tv-ad">
          <div class="tv-ad-text">📍 Anúncio patrocinado · Cartão de Crédito</div>
...
<div class="section">
  ...
  <div class="steps">
    ...
    <div class="step">
      <div class="step-icon">👗</div>
      <div class="step-content">
        <div class="step-title">2. Você mostra sua coleção e promoções</div>
        <div class="step-desc">Pelo celular, envia foto da coleção nova, promoção de troca de estação, combo de peças. Aparece na TV na hora, igual mandar foto no WhatsApp.</div>
      </div>
    </div>
    <div class="step">
      <div class="step-icon">💰</div>
      <div class="step-content">
        ...
        <div class="step-desc">Cartão de crédito, calçados, acessórios — eles pagam pra aparecer pra quem está na loja decidindo a compra. Você recebe todo mês, automaticamente.</div>
      </div>
    </div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="ganhos">
    ...
    <div class="ganhos-note">Valores baseados em estabelecimentos com movimento de terça a domingo, TV ligada durante o horário de funcionamento da loja.</div>
  </div>
</div>

<!-- POR QUE MODA -->
<div class="section">
  <div class="section-tag">Por que loja de moda</div>
  <div class="section-title">Seu cliente já navega<br>com tempo de sobra</div>
  <div class="segs">
    <div class="seg"><div class="seg-icon">👚</div><div class="seg-name">Tempo de navegação</div><div class="seg-desc">Cliente circula pela loja, olha araras, espera provador — tempo de tela ligada</div></div>
    <div class="seg"><div class="seg-icon">💳</div><div class="seg-name">Combina com crediário e cartão</div><div class="seg-desc">Anunciante financeiro adora esse tipo de compra parcelada</div></div>
    <div class="seg"><div class="seg-icon">🔁</div><div class="seg-name">Troca de estação</div><div class="seg-desc">Coleção nova a cada temporada traz o cliente de volta com frequência</div></div>
...
<div class="section" style="padding-top:0">
  <div class="prova">
    <div class="prova-quote">"A tecnologia por trás do DOOHPLAY já está rodando ao vivo hoje — instalação, conteúdo e anúncios funcionando de ponta a ponta. Moda é um segmento novo pra gente, mas o produto que você vai receber é o mesmo, testado todo dia."</div>
...
<div class="section">
  ...
  <div class="faq">
    ...
    <div class="faq-item">
      <div class="faq-q" onclick="toggleFaq(this)">Posso usar como vitrine digital? <span>+</span></div>
      <div class="faq-a">Sim. Você pode deixar looks, coleções e promoções tocando na tela, misturado com os anúncios pagos de outras marcas.</div>
    </div>
    <div class="faq-item">
