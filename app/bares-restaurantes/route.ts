...
<title>DOOHPLAY para Bares e Restaurantes — Transforme a TV do salão em renda extra</title>
<meta name="description" content="Seu cliente já passa tempo esperando a mesa, o prato ou a conta. Coloque uma TV, mostre seu cardápio e promoções — e ainda ganhe dinheiro com anúncios enquanto ele aproveita.">
<style>
...
/* CANAL ALIMENTAÇÃO */
.canal-box { background:linear-gradient(135deg,#3f1f0a,#0b1120); border:1px solid #D9770644; border-radius:20px; padding:28px; max-width:700px; margin:0 auto 48px; }
.canal-tag { display:inline-block; background:#D9770622; color:#FBBF24; border:1px solid #D9770655; border-radius:20px; padding:5px 14px; font-size:12px; font-weight:700; margin-bottom:14px; }
...
<!-- HERO -->
<div class="hero">
  <div class="hero-tag">🍔 Feito para bares e restaurantes</div>
  <h1>Enquanto o cliente<br>espera a mesa,<br><span>você já está ganhando</span></h1>
  <p>Seu cliente já espera pela mesa, pelo prato ou pela conta. Coloque uma TV, mostre seu cardápio e promoções — e ainda ganhe dinheiro com anúncios enquanto ele aproveita o momento.</p>
  <div class="hero-btns">
    ...
    <div class="tv-frame">
      <div class="tv-screen">
        ...
        <div class="tv-content">
          <div class="promo">🍹 Happy Hour</div>
          <div class="sub">Chopp em dobro — Das 18h às 20h</div>
        </div>
        <div class="tv-ad">
  ...
  <div class="steps">
    <div class="step">
      ...
      <div class="step-content">
        ...
        <div class="step-desc">Leva 15 minutos, sem atrapalhar o salão. Funciona em qualquer TV com Android ou Fire Stick.</div>
      </div>
    </div>
    <div class="step">
      <div class="step-icon">🍔</div>
      <div class="step-content">
        <div class="step-title">2. Você mostra cardápio e promoções</div>
        <div class="step-desc">Pelo celular, envia o prato do dia, promoção de happy hour, combo de fim de semana. Aparece na TV na hora, igual mandar foto no WhatsApp.</div>
      </div>
    </div>
    <div class="step">
      <div class="step-icon">💰</div>
      <div class="step-content">
        ...
        <div class="step-desc">Delivery, bebidas, bancos — eles pagam pra aparecer pra quem está no seu salão. Você recebe todo mês, automaticamente.</div>
      </div>
    </div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="canal-box">
    <div class="canal-tag">✅ Exclusivo pra bar, lanchonete e restaurante</div>
    <div class="canal-title">Sua tela já nasce com conteúdo de gastronomia pronto</div>
    <div class="canal-desc">Além das suas próprias promoções, sua tela recebe automaticamente o <strong>Canal Alimentação</strong> — conteúdo institucional com curiosidades gastronômicas e dicas de chef, pensado especificamente pra quem trabalha com comida e bebida. Você não precisa produzir nada a mais pra sua tela já sair cheia de conteúdo relevante.</div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="ganhos">
    ...
    <div class="ganhos-grid">
      <div class="ganha-card"><div class="ganha-num">2K</div><div class="ganha-label">exibições por dia</div></div>
    ...
    <div class="ganhos-note">Valores baseados em estabelecimentos com movimento de terça a domingo, TV ligada durante o horário de funcionamento (almoço e janta, os dois picos naturais de bar e restaurante).</div>
  </div>
</div>

<!-- POR QUE BAR/RESTAURANTE -->
<div class="section">
  <div class="section-tag">Por que bar e restaurante</div>
  <div class="section-title">Seu salão já reúne<br>tudo que anunciante procura</div>
  <div class="segs">
    <div class="seg"><div class="seg-icon">🍽️</div><div class="seg-name">Tempo de mesa</div><div class="seg-desc">Enquanto espera o prato ou a conta, o cliente olha pra tela — atenção garantida</div></div>
    <div class="seg"><div class="seg-icon">🌙</div><div class="seg-name">Pico de movimento à noite</div><div class="seg-desc">Happy hour e jantar reúnem público relaxado, com tempo disponível</div></div>
    <div class="seg"><div class="seg-icon">👨‍👩‍👧</div><div class="seg-name">Grupos, não só indivíduos</div><div class="seg-desc">Mesa cheia = mais gente vendo a mesma tela ao mesmo tempo</div></div>
    <div class="seg"><div class="seg-icon">🍹</div><div class="seg-name">Combina com bebida e delivery</div><div class="seg-desc">Anunciante de bebida, app de delivery e banco adoram esse público</div></div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="prova">
    <div class="prova-quote">"A tecnologia por trás do DOOHPLAY já está rodando ao vivo hoje — instalação, conteúdo e anúncios funcionando de ponta a ponta. Bar e restaurante é um segmento novo pra gente, mas o produto que você vai receber é o mesmo, testado todo dia."</div>
...
<div class="section">
  ...
  <div class="faq">
    ...
    <div class="faq-item">
      <div class="faq-q" onclick="toggleFaq(this)">Dá pra usar como cardápio digital também? <span>+</span></div>
      <div class="faq-a">Sim. Você pode deixar seu cardápio, prato do dia e promoções tocando na tela normalmente, misturado com o conteúdo do Canal Alimentação e os anúncios pagos.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q" onclick="toggleFaq(this)">Posso bloquear anúncio de bebida alcoólica? <span>+</span></div>
      <div class="faq-a">Sim, e o contrário também — você escolhe no seu dashboard quais categorias de anúncio aceita ou bloqueia (bebida alcoólica, apostas, conteúdo adulto/sensível, conteúdo político). Concorrente direto já é bloqueado automaticamente.</div>
    </div>
    <div class="faq-item">
