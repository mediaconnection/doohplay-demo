...
/* INVESTIMENTO */
.invest-box { background:${marketingDark.surface}; border:1px solid ${marketingDark.border}; border-radius:20px; padding:32px; max-width:700px; margin:0 auto 48px; text-align:center; }
