...
<title>DOOHPLAY para Clínicas — Transforme a sala de espera em renda extra</title>
<meta name="description" content="Seu paciente já espera na recepção antes da consulta. Coloque uma TV, mostre seus serviços — e ainda ganhe dinheiro com anúncios enquanto ele aguarda.">
<style>
...
<!-- HERO -->
<div class="hero">
  <div class="hero-tag">🩺 Feito para clínicas</div>
  <h1>O tempo de espera<br>antes da consulta<br><span>também pode render</span></h1>
  <p>Seu paciente já espera na recepção antes de ser atendido. Coloque uma TV, mostre seus serviços e horários — e ainda ganhe dinheiro com anúncios de saúde e bem-estar enquanto ele aguarda.</p>
  <div class="hero-btns">
    ...
    <div class="tv-frame">
      <div class="tv-screen">
        ...
        <div class="tv-content">
          <div class="promo">🩺 Check-up Completo</div>
          <div class="sub">Agende sua consulta preventiva</div>
        </div>
        <div class="tv-ad">
  ...
  <div class="steps">
    <div class="step">
      ...
      <div class="step-content">
        ...
        <div class="step-desc">Leva 15 minutos, sem atrapalhar a recepção. Funciona em qualquer TV com Android ou Fire Stick.</div>
      </div>
    </div>
    <div class="step">
      <div class="step-icon">🩺</div>
      <div class="step-content">
        <div class="step-title">2. Você mostra seus serviços e horários</div>
        <div class="step-desc">Pelo celular, envia especialidades atendidas, campanha de vacina, novo procedimento, horário de funcionamento. Aparece na TV na hora, igual mandar foto no WhatsApp.</div>
      </div>
    </div>
    <div class="step">
      <div class="step-icon">💰</div>
      <div class="step-content">
        ...
        <div class="step-desc">Planos de saúde, laboratórios, farmácias — eles pagam pra aparecer pra quem está aguardando a consulta. Você recebe todo mês, automaticamente.</div>
      </div>
    </div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="canal-box">
    <div class="canal-tag">✅ Exclusivo pra clínica e farmácia</div>
    <div class="canal-title">Sua tela já nasce com conteúdo de saúde pronto</div>
    <div class="canal-desc">Além das suas próprias informações, sua tela recebe automaticamente o <strong>Canal Saúde</strong> — conteúdo institucional sobre hidratação, prevenção e check-up, pensado especificamente pra clínica e farmácia. Você não precisa produzir nada a mais pra sua sala de espera já sair cheia de conteúdo relevante pro seu paciente.</div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="ganhos">
    ...
    <div class="ganhos-grid">
      <div class="ganha-card"><div class="ganha-num">900</div><div class="ganha-label">exibições por dia</div></div>
    ...
    <div class="ganhos-note">Valores baseados em estabelecimentos com movimento de segunda a sexta, TV ligada durante o horário de atendimento. Clínica costuma ter tempo de espera maior e público mais qualificado — por isso o valor médio de anúncio tende a ser mais alto que em outros segmentos.</div>
  </div>
</div>

<!-- POR QUE CLÍNICA -->
<div class="section">
  <div class="section-tag">Por que clínica</div>
  <div class="section-title">Sua sala de espera já tem<br>o público que anunciante quer</div>
  <div class="segs">
    <div class="seg"><div class="seg-icon">⏱️</div><div class="seg-name">Tempo de espera mais longo</div><div class="seg-desc">Consulta atrasa, exame demora — mais tempo de tela ligada por pessoa</div></div>
    <div class="seg"><div class="seg-icon">👥</div><div class="seg-name">Público qualificado</div><div class="seg-desc">Paciente de clínica é exatamente o perfil que anunciante de saúde busca</div></div>
    <div class="seg"><div class="seg-icon">🔁</div><div class="seg-name">Retorno programado</div><div class="seg-desc">Tratamentos e acompanhamentos trazem o mesmo paciente de volta</div></div>
    <div class="seg"><div class="seg-icon">🤝</div><div class="seg-name">Ambiente de confiança</div><div class="seg-desc">Anúncio de saúde combina com o ambiente — não é intrusivo, é esperado</div></div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="prova">
    <div class="prova-quote">"A tecnologia por trás do DOOHPLAY já está rodando ao vivo hoje — instalação, conteúdo e anúncios funcionando de ponta a ponta. Clínica é um segmento novo pra gente, mas o produto que você vai receber é o mesmo, testado todo dia — e o Canal Saúde foi pensado justamente com clínica e farmácia em mente."</div>
...
<div class="section">
  ...
  <div class="faq">
    ...
    <div class="faq-item">
      <div class="faq-q" onclick="toggleFaq(this)">Posso controlar quais anúncios aparecem na minha clínica? <span>+</span></div>
      <div class="faq-a">Sim. Você pode bloquear categorias inteiras (bebida alcoólica, apostas, conteúdo adulto/sensível, conteúdo político) direto no seu dashboard, e anúncio de clínica concorrente já é bloqueado automaticamente.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q" onclick="toggleFaq(this)">O que é o Canal Saúde? <span>+</span></div>
      <div class="faq-a">É conteúdo institucional pensado pra clínica e farmácia — dicas de prevenção, hidratação, check-up. Aparece automaticamente na sua tela, sem custo e sem trabalho extra, complementando suas próprias informações.</div>
    </div>
    <div class="faq-item">
