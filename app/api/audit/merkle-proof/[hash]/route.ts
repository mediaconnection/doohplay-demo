...
import { buildMerkleProof, buildMerkleRoot } from "@proof-engine/proof/merkle"
...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({
      ...
      merkle_root: storedRoot ?? computedRoot,
      computed_merkle_root: computedRoot,
      merkle_root_matches: storedRoot ? storedRoot === computedRoot : null,
      proof
    })
  } catch (error) {
