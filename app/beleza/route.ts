...
<title>DOOHPLAY para Salões de Beleza — Transforme a TV do salão em renda extra</title>
<meta name="description" content="Sua cliente já fica sentada durante a coloração, a escova ou a unha. Coloque uma TV, mostre seus serviços — e ainda ganhe dinheiro com anúncios enquanto ela relaxa.">
<style>
...
/* CANAL BELEZA */
.canal-box { background:linear-gradient(135deg,#3a0f2f,#0b1120); border:1px solid #DB277744; border-radius:20px; padding:28px; max-width:700px; margin:0 auto 48px; }
.canal-tag { display:inline-block; background:#DB277722; color:#F472B6; border:1px solid #DB277755; border-radius:20px; padding:5px 14px; font-size:12px; font-weight:700; margin-bottom:14px; }
...
<!-- HERO -->
<div class="hero">
  <div class="hero-tag">💅 Feito para salões de beleza</div>
  <h1>Enquanto ela espera<br>a coloração pegar,<br><span>você já está ganhando</span></h1>
  <p>Sua cliente já fica um bom tempo sentada — na coloração, na escova, na unha. Coloque uma TV, mostre seus serviços e promoções — e ainda ganhe dinheiro com anúncios enquanto ela relaxa.</p>
  <div class="hero-btns">
    <a href="/cadastro" class="btn-main">Quero ganhar dinheiro com minha TV 💇‍♀️</a>
...
<div class="tv-section">
  <div class="tv-wrap">
    <div class="money-badge">+R$380<br>/mês</div>
    <div class="tv-frame">
      <div class="tv-screen">
        <div class="tv-badge">● AO VIVO</div>
        <div class="tv-content">
          <div class="promo">💅 Manicure + Pedicure</div>
          <div class="sub">R$ 60 — Pacote da semana</div>
        </div>
        <div class="tv-ad">
          <div class="tv-ad-text">📍 Anúncio patrocinado · Cosméticos</div>
          <div class="tv-ad-logo">BelezaPlus</div>
        </div>
      </div>
    </div>
  ...
  <div class="steps">
    <div class="step">
      ...
      <div class="step-content">
        ...
        <div class="step-desc">Leva 15 minutos, sem atrapalhar o atendimento. Funciona em qualquer TV com Android ou Fire Stick.</div>
      </div>
    </div>
    <div class="step">
      ...
      <div class="step-content">
        ...
        <div class="step-desc">Pelo celular, envia foto de trabalho novo, pacote de coloração + escova, promoção de unha. Aparece na TV na hora, igual mandar foto no WhatsApp.</div>
      </div>
    </div>
    <div class="step">
      <div class="step-icon">💰</div>
      <div class="step-content">
        ...
        <div class="step-desc">Cosméticos, moda, bancos — eles pagam pra aparecer pra quem está sentada esperando. Você recebe todo mês, automaticamente.</div>
      </div>
    </div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="canal-box">
    <div class="canal-tag">✅ Exclusivo pra salão e barbearia</div>
    <div class="canal-title">Sua tela já nasce com conteúdo de beleza pronto</div>
    <div class="canal-desc">Além das suas próprias promoções, sua tela recebe automaticamente o <strong>Canal Beleza & Estética</strong> — conteúdo institucional com dicas de cuidado e tendências da semana, pensado especificamente pra quem trabalha com beleza. Você não precisa produzir nada a mais pra sua tela já sair cheia de conteúdo relevante pra sua cliente.</div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="ganhos">
    ...
    <div class="ganhos-grid">
      <div class="ganha-card"><div class="ganha-num">1.1K</div><div class="ganha-label">exibições por dia</div></div>
      <div class="ganha-card"><div class="ganha-num">R$380</div><div class="ganha-label">receita média/mês</div></div>
    ...
    <div class="ganhos-note">Valores baseados em estabelecimentos com movimento de terça a sábado, TV ligada durante o horário comercial. Serviços de salão costumam ter tempo de atendimento mais longo que barbearia — mais minutos de tela por cliente.</div>
  </div>
</div>

<!-- POR QUE SALÃO -->
<div class="section">
  <div class="section-tag">Por que salão de beleza</div>
  <div class="section-title">Sua cliente fica mais tempo<br>sentada do que em qualquer outro lugar</div>
  <div class="segs">
    <div class="seg"><div class="seg-icon">⏳</div><div class="seg-name">Tempo de atendimento longo</div><div class="seg-desc">Coloração, escova, alisamento — muitos minutos de tela ligada por cliente</div></div>
    <div class="seg"><div class="seg-icon">💄</div><div class="seg-name">Público-alvo de beleza</div><div class="seg-desc">Exatamente o perfil que anunciante de cosmético e moda quer alcançar</div></div>
    <div class="seg"><div class="seg-icon">🔁</div><div class="seg-name">Cliente fiel e recorrente</div><div class="seg-desc">Manutenção de cor, corte e unha traz a cliente de volta todo mês</div></div>
    <div class="seg"><div class="seg-icon">📺</div><div class="seg-name">Já tem TV? Já começa a ganhar</div><div class="seg-desc">Se já tem uma TV no salão, não precisa comprar nada pra começar</div></div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="prova">
    <div class="prova-quote">"A tecnologia por trás do DOOHPLAY já está rodando ao vivo hoje — instalação, conteúdo e anúncios funcionando de ponta a ponta. Salão de beleza é um segmento novo pra gente, mas o produto que você vai receber é o mesmo, testado todo dia — e o Canal Beleza & Estética foi pensado justamente pra esse público."</div>
...
<div class="section">
  ...
  <div class="faq">
    ...
    <div class="faq-item">
      <div class="faq-q" onclick="toggleFaq(this)">O que é o Canal Beleza & Estética? <span>+</span></div>
      <div class="faq-a">É conteúdo institucional pensado pra salão e barbearia — dicas de cuidado, tendências da semana. Aparece automaticamente na sua tela, sem custo e sem trabalho extra, complementando suas próprias promoções.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q" onclick="toggleFaq(this)">Posso controlar quais anúncios aparecem? <span>+</span></div>
      <div class="faq-a">Sim. Você pode bloquear categorias inteiras (bebida alcoólica, apostas, conteúdo adulto/sensível, conteúdo político) direto no seu dashboard, e anúncio de salão concorrente já é bloqueado automaticamente.</div>
    </div>
    <div class="faq-item">
