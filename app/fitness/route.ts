...
<title>DOOHPLAY para Academias — Transforme a TV da recepção em renda extra</title>
<meta name="description" content="Seu aluno já passa tempo na recepção, no descanso entre séries, esperando a aula começar. Coloque uma TV, mostre suas turmas — e ainda ganhe dinheiro com anúncios.">
<style>
...
<!-- HERO -->
<div class="hero">
  <div class="hero-tag">🏋️ Feito para academias</div>
  <h1>Enquanto ele descansa<br>entre as séries,<br><span>você já está ganhando</span></h1>
  <p>Seu aluno já passa tempo na recepção, no descanso entre séries, esperando a aula coletiva começar. Coloque uma TV, mostre suas turmas e promoções — e ainda ganhe dinheiro com anúncios.</p>
  <div class="hero-btns">
...
<div class="tv-section">
  <div class="tv-wrap">
    <div class="money-badge">+R$330*<br>/mês</div>
    <div class="tv-frame">
      <div class="tv-screen">
        <div class="tv-badge">● AO VIVO</div>
        <div class="tv-content">
          <div class="promo">🏋️ Aula de Cross às 19h</div>
          <div class="sub">Vagas limitadas — Inscreva-se na recepção</div>
        </div>
        <div class="tv-ad">
          <div class="tv-ad-text">📍 Anúncio patrocinado · Suplementos</div>
          <div class="tv-ad-logo">MaxProtein</div>
        </div>
      </div>
    </div>
  ...
  <div class="steps">
    <div class="step">
      ...
      <div class="step-content">
        ...
        <div class="step-desc">Leva 15 minutos, sem atrapalhar o funcionamento da academia. Funciona em qualquer TV com Android ou Fire Stick.</div>
      </div>
    </div>
    <div class="step">
      <div class="step-icon">🏋️</div>
      <div class="step-content">
        <div class="step-title">2. Você mostra turmas e promoções</div>
        <div class="step-desc">Pelo celular, envia horário de aula coletiva, promoção de matrícula, novo personal disponível. Aparece na TV na hora, igual mandar foto no WhatsApp.</div>
      </div>
    </div>
    <div class="step">
      <div class="step-icon">💰</div>
      <div class="step-content">
        ...
        <div class="step-desc">Suplementos, roupas fitness, bancos — eles pagam pra aparecer pra quem está treinando. Você recebe todo mês, automaticamente.</div>
      </div>
    </div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="canal-box">
    <div class="canal-tag">✅ Exclusivo pra academia</div>
    <div class="canal-title">Sua tela já nasce com conteúdo de bem-estar pronto</div>
    <div class="canal-desc">Além das suas próprias turmas e promoções, sua tela recebe automaticamente o <strong>Canal Fitness & Esportes</strong> — conteúdo institucional com motivação e dicas de bem-estar, pensado especificamente pra academia. Você não precisa produzir nada a mais pra sua tela já sair cheia de conteúdo relevante pro seu aluno.</div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="ganhos">
    ...
    <div class="ganhos-grid">
      <div class="ganha-card"><div class="ganha-num">1.3K</div><div class="ganha-label">exibições por dia</div></div>
      <div class="ganha-card"><div class="ganha-num">R$330</div><div class="ganha-label">receita média/mês</div></div>
    ...
    <div class="ganhos-note">Valores baseados em estabelecimentos com movimento de segunda a sábado, TV ligada durante o horário de funcionamento (picos de manhã cedo e final de tarde/noite).</div>
  </div>
</div>

<!-- POR QUE ACADEMIA -->
<div class="section">
  <div class="section-tag">Por que academia</div>
  <div class="section-title">Seu aluno já passa tempo<br>parado o dia inteiro</div>
  <div class="segs">
    <div class="seg"><div class="seg-icon">⏱️</div><div class="seg-name">Descanso entre séries</div><div class="seg-desc">Momentos parados entre exercícios são naturalmente olhados pra tela</div></div>
    <div class="seg"><div class="seg-icon">🔁</div><div class="seg-name">Cliente super recorrente</div><div class="seg-desc">Aluno de academia frequenta várias vezes por semana, o ano todo</div></div>
    <div class="seg"><div class="seg-icon">💪</div><div class="seg-name">Público engajado com saúde</div><div class="seg-desc">Perfil ideal pra anunciante de suplemento, roupa fitness e bem-estar</div></div>
    <div class="seg"><div class="seg-icon">📺</div><div class="seg-name">Já tem TV? Já começa a ganhar</div><div class="seg-desc">Se já tem uma TV na recepção ou na sala de musculação, não precisa comprar nada</div></div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="prova">
    <div class="prova-quote">"A tecnologia por trás do DOOHPLAY já está rodando ao vivo hoje — instalação, conteúdo e anúncios funcionando de ponta a ponta. Academia é um segmento novo pra gente, mas o produto que você vai receber é o mesmo, testado todo dia — e o Canal Fitness & Esportes foi pensado justamente com esse público em mente."</div>
...
<div class="section">
  ...
  <div class="faq">
    ...
    <div class="faq-item">
      <div class="faq-q" onclick="toggleFaq(this)">O que é o Canal Fitness & Esportes? <span>+</span></div>
      <div class="faq-a">É conteúdo institucional pensado pra academia — motivação, dicas de bem-estar. Aparece automaticamente na sua tela, sem custo e sem trabalho extra, complementando suas próprias turmas e promoções.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q" onclick="toggleFaq(this)">Posso usar em mais de uma tela (recepção e sala de musculação)? <span>+</span></div>
      <div class="faq-a">Sim, se o seu plano cobrir mais de uma tela (ou você pode adicionar uma tela extra). Cada tela pode ter conteúdo próprio ou repetir a mesma programação.</div>
    </div>
    <div class="faq-item">
