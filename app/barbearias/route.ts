...
<title>DOOHPLAY para Barbearias — Transforme a TV do salão em renda extra</title>
<meta name="description" content="Seu cliente já espera sentado esperando a vez. Coloque uma TV, mostre seus cortes e promoções — e ainda ganhe dinheiro com anúncios enquanto ele espera.">
<style>
...
<!-- HERO -->
<div class="hero">
  <div class="hero-tag">✂️ Feito para barbearias</div>
  <h1>Enquanto ele espera<br>a vez no corte,<br><span>você já está ganhando</span></h1>
  <p>Seu cliente já senta e espera a vez. Coloque uma TV, mostre seus cortes e promoções — e ainda ganhe dinheiro com anúncios enquanto ele aproveita a espera.</p>
  <div class="hero-btns">
...
<div class="section">
  ...
  <div class="steps">
    ...
    <div class="step">
      <div class="step-icon">💈</div>
      <div class="step-content">
        <div class="step-title">2. Você mostra seus cortes e promoções</div>
        <div class="step-desc">Pelo celular, envia foto de corte novo, promoção de combo barba+cabelo, tabela de preços. Aparece na TV na hora, igual mandar foto no WhatsApp.</div>
      </div>
    </div>
    <div class="step">
      <div class="step-icon">💰</div>
      <div class="step-content">
        ...
        <div class="step-desc">Delivery, produtos masculinos, bancos — eles pagam pra aparecer pra quem está sentado esperando. Você recebe todo mês, automaticamente.</div>
      </div>
    </div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="canal-box">
    <div class="canal-tag">✅ Exclusivo pra barbearia e salão</div>
    <div class="canal-title">Sua tela já nasce com conteúdo de beleza pronto</div>
    <div class="canal-desc">Além das suas próprias promoções, sua tela recebe automaticamente o <strong>Canal Beleza & Estética</strong> — conteúdo institucional com dicas de cuidado e tendências, pensado especificamente pra barbearia e salão. Você não precisa produzir nada a mais pra sua tela já sair cheia de conteúdo relevante pro seu cliente.</div>
  </div>
</div>
...
<!-- POR QUE BARBEARIA -->
<div class="section">
  <div class="section-tag">Por que barbearia</div>
  <div class="section-title">Sua barbearia já tem<br>a audiência perfeita</div>
  <div class="segs">
    <div class="seg"><div class="seg-icon">⏱️</div><div class="seg-name">Tempo de espera real</div><div class="seg-desc">Cliente sentado esperando a vez — atenção total pra tela, sem pressa</div></div>
    <div class="seg"><div class="seg-icon">🔁</div><div class="seg-name">Cliente fiel e recorrente</div><div class="seg-desc">Corte de cabelo é rotina — o mesmo cliente volta toda semana ou a cada 15 dias</div></div>
    <div class="seg"><div class="seg-icon">👥</div><div class="seg-name">Público engajado</div><div class="seg-desc">Ambiente descontraído, cliente presta atenção no que está passando na tela</div></div>
...
<div class="section">
  ...
  <div class="faq">
    ...
    <div class="faq-item">
      ...
      <div class="faq-a">É conteúdo institucional pensado pra barbearia e salão — dicas de cuidado, tendências da semana. Aparece automaticamente na sua tela, sem custo e sem trabalho extra, complementando suas próprias promoções.</div>
    </div>
    <div class="faq-item">
    ...
    <div class="faq-item">
      ...
      <div class="faq-a">Empresas locais e nacionais — delivery, produtos masculinos, bancos, seguros. Você pode ver e aprovar os anúncios pelo dashboard antes de aparecerem na sua tela.</div>
    </div>
  </div>
</div>
