...
<title>DOOHPLAY para Casa e Serviços — Transforme a TV da loja em renda extra</title>
<meta name="description" content="Seu cliente já passa tempo esperando orçamento, atendimento ou entrega. Coloque uma TV, mostre seus serviços — e ainda ganhe dinheiro com anúncios enquanto ele espera.">
<style>
...
<!-- HERO -->
<div class="hero">
  <div class="hero-tag">🏠 Feito para casa e serviços</div>
  <h1>Enquanto ele espera<br>o orçamento ficar pronto,<br><span>você já está ganhando</span></h1>
  <p>Seu cliente já passa tempo esperando orçamento, atendimento ou retirada de material. Coloque uma TV, mostre seus produtos e serviços — e ainda ganhe dinheiro com anúncios enquanto ele espera.</p>
  <div class="hero-btns">
    ...
    <div class="tv-frame">
      <div class="tv-screen">
        ...
        <div class="tv-content">
          <div class="promo">🏠 Tintas e Materiais</div>
          <div class="sub">15% OFF em reforma até o fim do mês</div>
        </div>
        <div class="tv-ad">
          <div class="tv-ad-text">📍 Anúncio patrocinado · Financeira</div>
          <div class="tv-ad-logo">CrediCasa</div>
        </div>
      </div>
    </div>
  ...
  <div class="steps">
    <div class="step">
      ...
      <div class="step-content">
        ...
        <div class="step-desc">Leva 15 minutos, sem atrapalhar o atendimento na loja. Funciona em qualquer TV com Android ou Fire Stick.</div>
      </div>
    </div>
    <div class="step">
      <div class="step-icon">🛠️</div>
      <div class="step-content">
        <div class="step-title">2. Você mostra produtos e serviços</div>
        <div class="step-desc">Pelo celular, envia promoção de material, novo serviço disponível, prazo de entrega. Aparece na TV na hora, igual mandar foto no WhatsApp.</div>
      </div>
    </div>
    <div class="step">
      <div class="step-icon">💰</div>
      <div class="step-content">
        ...
        <div class="step-desc">Financeiras, seguradoras, marcas de material de construção — eles pagam pra aparecer pra quem está na sua loja. Você recebe todo mês, automaticamente.</div>
      </div>
    </div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="ganhos">
    ...
    <div class="ganhos-grid">
      <div class="ganha-card"><div class="ganha-num">800</div><div class="ganha-label">exibições por dia</div></div>
    ...
    <div class="ganhos-note">Valores baseados em estabelecimentos com movimento de segunda a sábado, TV ligada durante o horário de funcionamento.</div>
  </div>
</div>

<!-- POR QUE CASA E SERVIÇOS -->
<div class="section">
  <div class="section-tag">Por que casa e serviços</div>
  <div class="section-title">Seu cliente já espera<br>mais tempo que a média</div>
  <div class="segs">
    <div class="seg"><div class="seg-icon">📋</div><div class="seg-name">Tempo de orçamento</div><div class="seg-desc">Enquanto o orçamento ou o pedido fica pronto, a atenção vai pra tela</div></div>
    <div class="seg"><div class="seg-icon">💳</div><div class="seg-name">Combina com crédito e financiamento</div><div class="seg-desc">Compra de material e reforma costuma ser parcelada — anunciante financeiro se interessa</div></div>
    <div class="seg"><div class="seg-icon">🔧</div><div class="seg-name">Cliente de ticket mais alto</div><div class="seg-desc">Reforma e manutenção envolvem valores maiores que consumo do dia a dia</div></div>
    <div class="seg"><div class="seg-icon">📺</div><div class="seg-name">Já tem TV? Já começa a ganhar</div><div class="seg-desc">Se já tem uma TV na loja, não precisa comprar nada pra começar</div></div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="prova">
    <div class="prova-quote">"A tecnologia por trás do DOOHPLAY já está rodando ao vivo hoje — instalação, conteúdo e anúncios funcionando de ponta a ponta. Casa e serviços é um segmento novo pra gente, mas o produto que você vai receber é o mesmo, testado todo dia."</div>
...
<div class="section">
  ...
  <div class="faq">
    ...
    <div class="faq-item">
      <div class="faq-q" onclick="toggleFaq(this)">Serve pra prestador de serviço sem loja física? <span>+</span></div>
      <div class="faq-a">O DOOHPLAY funciona melhor em locais com fluxo de gente esperando — loja de material, assistência técnica, escritório de atendimento. Se você não tem um ambiente assim, pode não ser o formato ideal ainda.</div>
    </div>
    <div class="faq-item">
