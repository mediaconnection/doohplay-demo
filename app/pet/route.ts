...
<title>DOOHPLAY para Petshops — Transforme a TV do balcão em renda extra</title>
<meta name="description" content="Seu cliente já espera enquanto o pet toma banho ou tosa. Coloque uma TV, mostre seus serviços — e ainda ganhe dinheiro com anúncios enquanto ele aguarda.">
<style>
...
/* CANAL PET */
.canal-box { background:linear-gradient(135deg,#2f1f0a,#0b1120); border:1px solid #D9770644; border-radius:20px; padding:28px; max-width:700px; margin:0 auto 48px; }
...
<!-- HERO -->
<div class="hero">
  <div class="hero-tag">🐾 Feito para petshops</div>
  <h1>Enquanto o pet<br>toma banho e tosa,<br><span>você já está ganhando</span></h1>
  <p>Seu cliente já espera enquanto o pet é atendido. Coloque uma TV, mostre seus serviços e promoções — e ainda ganhe dinheiro com anúncios enquanto ele aguarda.</p>
  <div class="hero-btns">
    ...
    <div class="tv-frame">
      <div class="tv-screen">
        ...
        <div class="tv-content">
          <div class="promo">🐾 Banho + Tosa</div>
          <div class="sub">R$ 55 — Pacote mensal com desconto</div>
        </div>
        <div class="tv-ad">
          <div class="tv-ad-text">📍 Anúncio patrocinado · Ração Premium</div>
          <div class="tv-ad-logo">PetLove</div>
        </div>
      </div>
    </div>
  ...
  <div class="steps">
    <div class="step">
      ...
      <div class="step-content">
        ...
        <div class="step-desc">Leva 15 minutos, sem atrapalhar o atendimento no balcão. Funciona em qualquer TV com Android ou Fire Stick.</div>
      </div>
    </div>
    <div class="step">
      <div class="step-icon">🐕</div>
      <div class="step-content">
        ...
        <div class="step-desc">Pelo celular, envia foto de banho e tosa, promoção de ração, pacote de vacinas. Aparece na TV na hora, igual mandar foto no WhatsApp.</div>
      </div>
    </div>
    <div class="step">
      <div class="step-icon">💰</div>
      <div class="step-content">
        ...
        <div class="step-desc">Ração, plano de saúde pet, veterinária — eles pagam pra aparecer pra quem está esperando o pet ser atendido. Você recebe todo mês, automaticamente.</div>
      </div>
    </div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="canal-box">
    <div class="canal-tag">✅ Exclusivo pra petshop</div>
    <div class="canal-title">Sua tela já nasce com conteúdo de cuidado animal pronto</div>
    <div class="canal-desc">Além das suas próprias promoções, sua tela recebe automaticamente o <strong>Canal Pet & Animais</strong> — conteúdo institucional com dicas de cuidado com o pet, pensado especificamente pra quem tem petshop. Você não precisa produzir nada a mais pra sua tela já sair cheia de conteúdo relevante pro seu cliente.</div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="ganhos">
    ...
    <div class="ganhos-grid">
      <div class="ganha-card"><div class="ganha-num">1K</div><div class="ganha-label">exibições por dia</div></div>
    ...
    <div class="ganhos-note">Valores baseados em estabelecimentos com movimento de segunda a sábado, TV ligada durante o horário de funcionamento. Tempo de banho e tosa costuma ser mais longo que outros serviços — mais minutos de tela por cliente.</div>
  </div>
</div>

<!-- POR QUE PETSHOP -->
<div class="section">
  <div class="section-tag">Por que petshop</div>
  <div class="section-title">Seu petshop já tem<br>um público apaixonado</div>
  <div class="segs">
    <div class="seg"><div class="seg-icon">⏱️</div><div class="seg-name">Tempo de espera longo</div><div class="seg-desc">Banho e tosa demoram — o dono do pet fica ali, de olho na tela</div></div>
    <div class="seg"><div class="seg-icon">❤️</div><div class="seg-name">Público apaixonado e fiel</div><div class="seg-desc">Dono de pet gasta com carinho — perfil ideal pra anunciante premium</div></div>
    <div class="seg"><div class="seg-icon">🔁</div><div class="seg-name">Visita recorrente</div><div class="seg-desc">Banho, tosa, ração e vacina trazem o mesmo cliente de volta sempre</div></div>
    <div class="seg"><div class="seg-icon">📺</div><div class="seg-name">Já tem TV? Já começa a ganhar</div><div class="seg-desc">Se já tem uma TV no petshop, não precisa comprar nada pra começar</div></div>
  </div>
</div>
...
<div class="section" style="padding-top:0">
  <div class="prova">
    <div class="prova-quote">"A tecnologia por trás do DOOHPLAY já está rodando ao vivo hoje — instalação, conteúdo e anúncios funcionando de ponta a ponta. Petshop é um segmento novo pra gente, mas o produto que você vai receber é o mesmo, testado todo dia — e o Canal Pet & Animais foi pensado justamente com esse público em mente."</div>
...
<div class="section">
  ...
  <div class="faq">
    ...
    <div class="faq-item">
      <div class="faq-q" onclick="toggleFaq(this)">O que é o Canal Pet & Animais? <span>+</span></div>
      <div class="faq-a">É conteúdo institucional pensado pra petshop — dicas de cuidado com o pet. Aparece automaticamente na sua tela, sem custo e sem trabalho extra, complementando suas próprias promoções.</div>
    </div>
    <div class="faq-item">
