...
/**
 * fix-verify-page.js
 * Detecta se app/verify/[hash]/page.tsx está incompleto (< 100 linhas)
 * e substitui pelo conteúdo correto antes do build.
 * Também remove arquivos duplicados que causam conflito.
 */
...
const CORRECT_CONTENT = `"use client"
...
for (const dup of DUPLICATES) {
  if (fs.existsSync(dup)) {
    ...
    console.log(`[fix-verify-page] 🗑  Duplicata removida: ${dup}`)
  }
}

console.log("[fix-verify-page] Concluído.")
