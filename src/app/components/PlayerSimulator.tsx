...
const PLAYLIST: AdSlot[] = [
  { id: "ad1", advertiser: "AutoFinance",   duration: 15, type: "video", bg: "#0A1428", accent: "#4F6EF7", headline: "Financie seu carro em 5 min",  cta: "Simule grátis",     proofId: "POP-AF7K2M9X" },
  { id: "ad2", advertiser: "TechStore",     duration: 30, type: "video", bg: "#0D0A1E", accent: "#7C5CFC", headline: "iPhone 16 Pro — chegou",        cta: "Ver na loja",       proofId: "POP-TS3N8P2R" },
  { id: "ad3", advertiser: "FitPlus",       duration: 15, type: "image", bg: "#041510", accent: "#00DC82", headline: "Matrícula com 50% OFF",          cta: "Matricule-se",      proofId: "POP-FP9L4Q7V" },
  { id: "ad4", advertiser: "iFood",         duration: 15, type: "video", bg: "#150800", accent: "#FFAA00", headline: "Delivery em 30 minutos",         cta: "Peça agora",        proofId: "POP-IF2B6D5W" },
  { id: "ad5", advertiser: "Bradesco",      duration: 30, type: "image", bg: "#010820", accent: "#4F6EF7", headline: "Conta digital sem taxas",        cta: "Abrir conta",       proofId: "POP-BD8C1F3Y" },
];
        ...
        <div className="max-w-2xl mx-auto px-6 py-4 flex items-center gap-4">
          ...
          <div className="ml-auto flex items-center gap-2">
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold"
              style={{ background: status === "playing" ? T.success + "15" : status === "offline" ? T.danger + "15" : T.warning + "15",
          ...
          <>
            ...
            <div className="rounded-3xl overflow-hidden border-4 relative" style={{ borderColor: "#1a1a2e", aspectRatio: "16/9" }}>
              {status === "offline" ? (
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center"
                  style={{ background: current.bg, opacity: brightness / 100 }}>
                  ...
                  <div className="relative z-0 text-center px-8">
                    ...
                    <div className="inline-block px-6 py-2.5 rounded-2xl font-black text-lg mt-2"
                      style={{ background: current.accent, color: "#000" }}>{current.cta}</div>
                  </div>
                  {/* Watermark */}
                  ...
                  <div className="absolute top-3 left-3 px-2.5 py-1 rounded-full text-xs"
                    style={{ background: "rgba(0,0,0,0.5)", color: T.textSub }}>
            ...
            <div className="flex items-center justify-between p-4 rounded-2xl border" style={{ background: T.card, borderColor: T.border }}>
              ...
              <div className="text-center">
                ...
                <div className="text-xs" style={{ color: T.textSub }}>
                  {Math.ceil((1 - progress / 100) * current.duration)}s restantes · {currentIdx + 1}/{PLAYLIST.length}
                </div>
              </div>
              <button onClick={goOffline}
                className="w-10 h-10 rounded-xl flex items-center justify-center"
                style={{ background: status === "offline" ? T.danger + "20" : T.panel, color: status === "offline" ? T.danger : T.textSub, border: `1px solid ${T.border}` }}>
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-2xl border" style={{ background: T.card, borderColor: T.border }}>
              ...
              <div className="flex items-center gap-3">
                ...
                <input type="range" min={20} max={100} value={brightness} onChange={e => setBrightness(Number(e.target.value))}
            ...
            <button className="w-full py-3 rounded-xl font-bold flex items-center justify-center gap-2"
              style={{ background: T.warning + "15", color: T.warning, border: `1px solid ${T.warning}25` }}>
